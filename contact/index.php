...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    require_once(ROOT_PATH . "included/phpmailer/class.phpmailer.php");
    $mail = new PHPMailer();
    ...
    if (!isset ($error_message)){
	    ...
	    $address = "lionjet19@gmail.com";
		$mail->addAddress ( $address, "Shirts 4 Alex" );
		$mail->Subject = "PHPMailer Test Subject via mail() method, basic sent for " . $name;
